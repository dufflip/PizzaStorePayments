...
import { ACTION_faturamento } from "../../store/ducks/cart";
      ...
      <div className="container-SS">
        <form>
          <main className="main-SS">
            <h1 className="title">Endereço de Faturamento</h1>
          ...
          <div className="div-button-SS">
            <button
              className="button-SS"
              onClick={() => dispatch(ACTION_faturamento({ ...state }))}
            >
              <Link className="button-link-SS" to="/third-step">
                Next Step
              </Link>
            </button>
          </div>
